ContainerMod2 : Elem {
    # "Containers. Ver.2 - using LSC approach"
    # "TODO To have Start and End as specific slots with CPs"
    About : Content {
        = "FAP3 visualization system. Containers module."
    }
    + FvWidgets
    + DesUtils
    SlotCp : Socket {
    ...
    DContainer : Des {
        ...
        IoSync : DcSyncS
        Cp : Extd {
            Int : FvWidgets.WidgetCpc
        }
        Controlled : FvWidgets.FWidgetBase {
