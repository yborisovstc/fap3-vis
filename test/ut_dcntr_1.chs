testroot : Elem {
    ...
    Test : DesLauncher {
        ...
        VBox_AddWdg.Enable ~ : State {
            = "SB true"
        }
        VBox_AddWdg.Name ~ : State {
            = "SS Btn3"
        }
        VBox_AddWdg.Parent ~ : State {
            = "SS FvWidgets.FButton"
        }
        VBox_AddWdg.Pos ~ : State {
            = "SI 0"
        }
        VBox_AddWdg.Mut ~ : State {
            = "CHR2 { SText < = \\\"SS Button 3\\\";  BgColor < { R = \\\"0.0\\\"; G = \\\"0.0\\\"; B = \\\"1.0\\\"; } FgColor < { R = \\\"1.0\\\"; G = \\\"1.0\\\"; B = \\\"1.0\\\"; } }"
        }
        AddedWdg_Dbg : State (
            _@ <  {
                Debug.LogLevel = "Dbg"
