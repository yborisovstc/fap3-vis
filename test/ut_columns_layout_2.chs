testroot : Elem
{
	...
	Clms_AddWdg.Name ~ : State { = "SS BtnNew"; };
	Clms_AddWdg.Parent ~ : State { = "SS FvWidgets.FButton"; };
	Clms_AddWdg.Pos ~ : State { = "SI 0"; };
        Clms_AddWdg.Mut ~ : State { = "CHR2 { SText < = \"SS Button New\";  BgColor < { R = \"0.0\"; G = \"0.0\"; B = \"1.0\";  A = \"1.0\"; } FgColor < { R = \"1.0\"; G = \"1.0\"; B = \"1.0\"; } }"; };
        AddedWdg_Dbg : State @ {
            _@ < {
                Debug.LogLevel = "Dbg";
                = "SB false";
